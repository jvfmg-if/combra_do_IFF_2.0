...
def reinicializar(msg_morte):
  global jogo_comecou, old_direction_guardado, snake_pos, apple_pos, velocidade, qual, pode_comecar, my_direction, old_direction, morreu, pontos, menu_morte, pode_botoes_menu, jogo_comecou, pausado, aba_placar, pode_botoes_menu, botao_play, estado_play, botao_placar, estado_placar, botao_sair, estado_sair, botao_menu, estado_menu, botao_creditos, estado_creditos, jogo_comecou, pausado, old_direction_guardado, allmapa, allwall, morreu, pode_clicar, menu_morte, pode_botoes_menu
...
def jogo():
  ...
  #adicionar creditos
      ...
      preto_transparente.blit(bd,(45,460))
      preto_transparente.blit(creditos3,(45,500))

      preto_transparente.blit(graficos,(45,560))
      preto_transparente.blit(creditos2,(45,600))
      
      preto_transparente.blit(dub,(45,660))
      preto_transparente.blit(creditos3,(45,700))
      preto_transparente.blit(creditos4,(45,740))

      preto_transparente.blit(site,(45,800))
      preto_transparente.blit(creditos3,(45,840))

      preto_transparente.blit(musica,(45,900))
      preto_transparente.blit(kevin,(45,940))
